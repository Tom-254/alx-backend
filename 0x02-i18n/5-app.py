...
def get_user() -> Union[Dict, None]:
    ...
    Returns:
        A dictionary representing a user if found, otherwise None.
    """
...
def get_locale() -> str:
    ...
    Returns:
        A string representing the locale for the web page.
    """
...
def get_index() -> str:
    ...
    Returns:
        A string representing the rendered template for the home/index page.
    """
